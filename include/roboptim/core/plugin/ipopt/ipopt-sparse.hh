...
namespace roboptim
{
  ...
  class ROBOPTIM_CORE_PLUGIN_IPOPT_DLLAPI IpoptSolverSparse
    : public IpoptSolverCommon<Solver<EigenMatrixSparse> >
  {
  public:
    ...
    explicit IpoptSolverSparse (const problem_t& problem);
